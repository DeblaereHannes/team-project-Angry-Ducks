...
var showPauseMenu = false, ShowReconnectionScreen = false, btnPause, btnExit, bluetoothConnected = false, bluetoothConnected2 = false, timeStampHR, timeStampHR2;
      ...
      if(player2plays == true && wichbutton == 2 && player2enable == true){
        ...
        if(player2plays == false && wichbutton == 1 && player2enable == true){
          ...
          if(player2enable == false && wichbutton == 1){
            ...
            if(wichbutton == 3 && player2plays != true){
              if(HR != null){
                ShootHR = (HR - CalmHR) / 5;
                var speed = ShootHR;
              }else{
              ...
              if(wichbutton == 4 && player2plays == true){
                if(HR != null){
                  ShootHR = (HR2 - CalmHR2) / 5;
                  var speed = ShootHR;
                }else{
